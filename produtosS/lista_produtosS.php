...
<body>
  ...
  <header>
    <div class="voltar">
      <a class="Home" href="../users/user_pageS.php">Sair</a>
    </div>
  </header>
        ...
        <tbody>
          <?php while($dados = mysqli_fetch_assoc($resultado_consulta)){?>
                  ...
                  <tr>
                    ...
                    <td><a href="form_atualizar_S.php?id=<?php echo $dados['id'];?>">Atualizar</a><i class="fa-solid fa-user-pen"></i></td>

                    <td><a href="excluir_produtosS.php?id=<?php echo $dados['id'];?>">Excluir</a><i class="fa-solid fa-trash"></i></td>
                  </tr>
