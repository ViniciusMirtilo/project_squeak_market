<?php
  ...
  $sql_consulta = "SELECT * FROM vinicius_componentes_c";
...
<body>
  ...
  <header>
    <div class="voltar">
      <a class="Home" href="../users/user_pageC.php">Sair</a>
    </div>
  </header>
  ...
  <table class="tabela">
        ...
        <tbody>
          <?php while($dados = mysqli_fetch_assoc($resultado_consulta)){?>
                  ...
                  <tr>
                    <td><?php echo $dados['nome_cervejas']; ?>
