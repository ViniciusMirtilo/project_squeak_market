...
<html lang="en">
  <head>
    ...
    <title>Squeak Market - shop</title>
  </head>
  <body>
    <header class="menu-img">
      <div class="center">
        ...
        <div class="menu">
          ...
          <a class="abou" href="../users/adm_pageS.php">Salgadinhos</a>
          <a class="abou" href="../users/adm_pageV.php">Legumes</a>
          <a class="abou" href="../necessario/lista_usuario.php">Adm Page</a>
          <a class="abou" href="../produtosC/adm_lista_produtosC.php">Lista de compras</a>
